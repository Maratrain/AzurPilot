    ...
    def _build_ap_chart_asset_data(self, asset_timeline, current_view):
        ...
        if asset_list:
            ...
            if valid_asset:
                ...
                legend_html += '<span class="ap-legend-item" data-series="3" style="display:flex; align-items:center; gap:4px;cursor:pointer;opacity:1;"><span style="width:12px; height:2px; background:#65996D; border-radius:1px;"></span>资产</span>'
